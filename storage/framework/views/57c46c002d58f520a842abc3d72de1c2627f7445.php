...
<div class="container">
	<div class="panel panel-info">
		...
		<center><a class="btn btn-primary" href="<?php echo e(url('tunjanganpegawai/create')); ?>">Tambah Data</a></center><br>
			<table class="table table-striped table-bordered table-hover">
				...
				<?php $no=1; ?>
				<?php $__currentLoopData = $tunjanganpegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tunjanganpegawais): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
				<tbody>
					<tr> 
						<td> <?php echo e($no++); ?> </td>
